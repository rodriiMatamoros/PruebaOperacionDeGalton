# PruebaOperacionDeGalton
### Mi repositorio es: https://github.com/rodriiMatamoros/PruebaOperacionDeGalton.git

## La Operación de Galton en la Fábrica de Campanas de Gauss
